...
/**
 * Self-contained V8 operation source. The Node worker owns the effect
 * decision; this function only loads one registered projection, applies the
 * already-checked write plan, and returns receipt-backed evidence.
 */
const EFFECT_OPERATION_SOURCE = String.raw`function (spreadsheet, args) {
  var MAX_EFFECTS = 20;
