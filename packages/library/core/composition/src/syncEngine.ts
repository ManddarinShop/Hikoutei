 ...
 * composition root through `packages/library/core/composition/src/index.ts`, which registers the
 ...
 * first time `packages/library/core/composition/src/index.ts` dynamically imports this module.
 */
