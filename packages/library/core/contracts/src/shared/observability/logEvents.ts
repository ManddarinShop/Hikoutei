...
export const HIKOUTEI_LOG_STABLE_CODES = Object.freeze([
  ...
  // Sync sheets contract codes (packages/library/core/sync-engine/src/sync/sheetsContract/errors.ts).
  ...
  // Sync service bootstrap codes (packages/library/core/sync-engine/src/sync/service/errors.ts).
  "invalid_sync_service_options",
  "invalid_sync_projection_config",
  "sync_provider_unavailable",
  "sync_service_startup_failed",
  // Existing-sheet adoption (packages/library/core/sync-engine/src/sync/service/adopt/existingSheetAdoption.ts).
  ...
  // Mapped ORM facade codes (packages/library/core/sync-engine/src/orm/errors.ts).
 ...
 * `packages/library/core/sync-engine/src/sync/sheetsContract/errors.ts`. Only proven invalid-
 ...
 * `packages/library/core/sync-engine/src/sync/sheetsContract/errors.ts`. Every value is a stable
