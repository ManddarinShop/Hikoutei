...
// P8-C: the sync-ORM mapping contracts are leaf modules; the registry inputs
// were already extracted to the leaf in P8-B, so the import resolves inside
// the leaf directly instead of through the infrastructure re-export shim.
import type { RegisterSyncSheetInput } from "../../storage/syncRegistry.js";
import type { NormalizedCellKind } from "../../encoding/constants.js";
